...
export function normalizeAuthoredSuccessorTaskV01(value: unknown): AuthoredSuccessorTaskDefinitionV01 {
  ...
  requireSuccessorV01(Array.isArray(d.checks) && d.checks.length > 0 && d.checks.length <= 8 &&
  ...
  requireSuccessorV01(task.non_goals.length > 0 && task.success_criteria.length === d.checks.length, "definition_not_normalized");
  requireSuccessorV01(Array.isArray(d.materials) && d.materials.length > 0 && d.materials.length <= 8 &&
    ...
    d.materials.some(m => m.role === "task_data") &&
...
export function readAuthoredSuccessorDefinitionV01(packet: TaskContextPacketV01): AuthoredSuccessorTaskDefinitionV01 {
  ...
  const definition = normalizeAuthoredSuccessorTaskV01(value);
